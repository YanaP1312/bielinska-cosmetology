...
<div className="flex justify-center">
            <Image src="/images/about_me/TB2.png" alt="Tetiana Bielinska logo for title" width={260} height={216} className="mb-2 lg:mb-0 lg:w-[320px]" />
            </div>
            <h1 aria-label="Tetiana Bielinska - cosmetologist-esthetician" className="text-xl tracking-wider text-right mb-10 ml-auto w-[220px] md:max-w-[440px]  lg:text-2xl  lg:w-[300px] lg:mb-12">
      &mdash;&nbsp;{t("title")}
    </h1>
    ...
    <Image src="/images/about_me/TV.jpg" alt="Tetiana Bielinska foto" width={328} height={491} className="border border-primary rounded-xl w-max "/> 
         ...
         <div className="grid grid-cols-1 text-justify lg:text-xl lg:grid-cols-2 lg:gap-10">
            ...
            <p>{t("intro")}</p>
            <p>{t("background")}&nbsp;<Link href="/qualification" className="common-accent hover-interaction hover:text-primary">{t("background_span")}</Link></p>
            <p>{t("education")}<Link href="/services" className="common-accent hover-interaction hover:text-primary">{t("education_span")}</Link></p>
            </div>
